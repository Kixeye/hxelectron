...
@:jsRequire("electron", "dialog") extern class Dialog {
	...
	**/
	...
	/**
		Shows a message box, it will block the process until the message box is closed. The browserWindow argument allows the dialog to attach itself to a parent window, making it modal.
	**/
	...
	**/
	...
	@:overload(function(?browserWindow:electron.main.BrowserWindow, options:{ /**
